...
def f_modelSummary(final_model_name, final_model):
    ...
    if final_model_name == 'Baseline':
        ...
        feature_importances = [(feature, round(importance, 2)) for feature, importance in zip(list(train_x_transformed.columns), importances)]
...
from models.train_model import final_model_name, final_model, train_x_transformed, train_y, train_pred, train_pred_1

# =============================================================================
# def main(final_model_name, final_model, train_x_transformed, train_y, train_pred):
