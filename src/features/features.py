...
#from test import name_pred
name_pred = 'AAL'
date_pred = datetime.datetime(2017,10,9)

#Make dataframe
df_ticker_all = df_cs1_new[df_cs1_new['Name'] == name_pred]
#df_ticker_all = df_ticker_all.set_index('date')
df_ticker_pred = df_ticker_all[df_ticker_all['date'] < date_pred]
